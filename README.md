...
**On Windows:**
Download the installer from **git-lfs.github.com**, run it, then open Command Prompt and run:
```
git lfs install
```
...
Check your email for a GitHub collaboration invite from **nstjean05**.
Click the link to accept it before trying to clone.
